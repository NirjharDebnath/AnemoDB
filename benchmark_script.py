...
# Create a connection pool in Python so DB connection overhead doesn't skew results
db_pool = psycopg2.pool.ThreadedConnectionPool(minconn=1, maxconn=10, **DB_CONFIG)
...
if __name__ == "__main__":
    ...
    print("=" * 65)
    print(f"Executing {len(queries)} mixed queries across 10 concurrent threads...")
    print("=" * 65)
